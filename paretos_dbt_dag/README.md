...
You can start writing assets in `paretos_project/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `paretos_project_tests` directory and you can run tests using `pytest`:

```bash
pytest paretos_project_tests
```
